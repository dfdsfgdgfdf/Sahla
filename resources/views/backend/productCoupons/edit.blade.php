...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Edit Product Coupon</h6>
            <div class="ml-auto">
                <a href="{{ route('admin.productCoupons.index') }}" class="btn btn-primary">
                    <span class="icon text-white-50">
                        <i class="fa fa-home"></i>
                    </span>
                    <span class="text">Product Coupons</span>
                </a>
            </div>
        </div>
        <div class="card-body">

            <form action="{{ route('admin.productCoupons.update', $productCoupon->id) }}" method="post"
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <select name="type" class="form-control">
                            <option value="Fixed"
                                {{ old('type', $productCoupon->productCoupon) == 'Fixed' ? 'selected' : null }}>Fixed
                            </option>
                            <option value="Percentage"
                                {{ old('type', $productCoupon->productCoupon) == 'Percentage' ? 'selected' : null }}>
                                Percentage
                            </option>
                        </select>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="use_times">Coupon Use_Times</label>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <label for="greater_than">Coupon Greater Than</label>
                    ...
                    <div class="col-4">
                        ...
                        <select name="status" class="form-control">
                            <option value="1"
                                {{ old('status', $productCoupon->status) == '1' ? 'selected' : null }}>Active
                            </option>
                            <option value="0"
                                {{ old('status', $productCoupon->status) == '0' ? 'selected' : null }}>Inactive
                            </option>
                        </select>
