...
@section('title', 'Create Product Coupon')
...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Create Product Coupon</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.productCoupons.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-4">
