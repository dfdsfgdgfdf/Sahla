                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <select name="sort_by" class="form-control form-control-solid">
                                ...
                                <option value="name" {{ old('sort_by', request()->input('name')) == 'name' ? 'selected' : ''  }}>الاسم</option>
                                <option value="created_at" {{ old('created_at', request()->input('created_at')) == 'created_at' ? 'selected' : ''  }}>تاريخ الاضافة</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-2">
