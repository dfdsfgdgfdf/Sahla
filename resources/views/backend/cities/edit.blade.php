...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <div class="col-6">
                <h6 class="m-0 font-weight-bold text-primary">تعديل المدينة </h6>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <select name="status" class="form-control">
                            <option value="1" {{ old('status', $city->status) == 1 ? 'selected' : null }}>نشط</option>
                            <option value="0" {{ old('status', $city->status) == 0 ? 'selected' : null }}>غير نشط</option>
                        </select>
