    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-6 d-flex text-left">
                <h1 class=" text-left">طلبات الفاتورة رقم ({{ $invoice->invoice_number }})</h1>
            </div>
...
{{--                                    <option value="rejected"{{ $order->status == "rejected" ? 'selected' : '' }}>قائمة الطلبات المرفوضة</option>--}}
                                    <option value="completed"{{ $order->status == "completed" ? 'selected' : '' }}>قائمة الطلبات المكتملة(المسددة)</option>
                                </select>
                            </td>
{{--                            <td class="text-center">--}}
