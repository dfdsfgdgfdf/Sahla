...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <div class="col-6">
                <h6 class="m-0 font-weight-bold text-primary">تعديل دولة</h6>
            </div>
                ...
                <div class="row">
                    <div class="col-9">
                        <div class="form-group">
                            <label for="name">اسم الدلة</label>
                    ...
                    <div class="col-3">
                        ...
                        <select name="status" class="form-control">
                            <option value="1" {{ old('status', $country->status) == 1 ? 'selected' : null }}>نشط</option>
                            <option value="0" {{ old('status', $country->status) == 0 ? 'selected' : null }}>غير نشط</option>
                        </select>
